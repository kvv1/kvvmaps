...
public class PathDrawer {
	...
	public static void drawPaths(Paths paths, GC gc, long tileId,
		...
		double lon = Utils.x2lon(x0, z, Adapter.TILE_SIZE);
		double lonw = Utils.x2lon(x1, z, Adapter.TILE_SIZE) - lon;
		double lat = Utils.y2lat(y1, z, Adapter.TILE_SIZE);
		double lath = Utils.y2lat(y0, z, Adapter.TILE_SIZE) - lat;
