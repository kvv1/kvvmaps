...
public class LocationX implements ISelectable {
	...
	public int getXint(int zoom) {
		return (int) Utils.lon2x(lon, zoom, Adapter.TILE_SIZE);
	}

	public int getYint(int zoom) {
		return (int) Utils.lat2y(lat, zoom, Adapter.TILE_SIZE);
	}

	public double getX(int zoom) {
		return Utils.lon2x(lon, zoom, Adapter.TILE_SIZE);
	}

	public double getY(int zoom) {
		return Utils.lat2y(lat, zoom, Adapter.TILE_SIZE);
	}
